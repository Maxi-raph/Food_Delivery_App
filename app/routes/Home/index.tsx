    ...
    return ( 
        <>
          <section 
            ...
            <Link to={'/explore'} className="text-white py-3 px-6 font-bold
          ...
          <section 
            ...
            <p className="text-white mb-8 text-md md:text-2xl max-w-3xl">Explore exciting new dishes, crafted with the freshest ingredients and authentic Nigerian flavors. Limited time offer!</p>
            <Link to={'/explore'} className="text-white py-3 px-6
             text-center bg-[#FF7A18] rounded-md font-bold">
            Discover what's new</Link>
          </section>
        </>
    );
